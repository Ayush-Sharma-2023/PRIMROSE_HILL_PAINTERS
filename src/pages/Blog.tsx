        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {BLOG_POSTS.map((post) => (
            <Link
              ...
              className="block"
            >
              <article className="bg-white border border-cream-200 overflow-hidden service-card">
                ...
                <div className="p-6">
                  <p className="text-xs text-charcoal-400 tracking-wide mb-2">
                    {post.date}
                  </p>

                  <h3 className="font-serif text-xl text-charcoal-800 mb-2">
                    {post.title}
                  </h3>
